...
export const AddGiftDialog: React.FC<Props> = ({handleAddGift, duplicatedValues}) => {
  const [isOpen, setIsOpen] = useState(false);
  const {register, handleSubmit, reset, setValue} = useForm<IGift>({
    defaultValues: duplicatedValues ? duplicatedValues : initialValues,
  });
